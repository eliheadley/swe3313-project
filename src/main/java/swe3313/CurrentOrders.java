...
public class CurrentOrders extends Page implements ActionListener {
    ...
    int numOrders;
    String [] columnNames = {"Status", "Order ID", "Name on Order", "Address","Payment Type","Delivery"};
    ...
    public CurrentOrders(){
        ...
        Object [][] data = {
                {"Status", "Order ID", "Name on Order", "Address","Payment Type","Delivery"},
                { " ", " ", " ", " ", " ", " "},
                { " ", " ", " ", " ", " ", " "},
                { " ", " ", " ", " ", " ", " "},
                { " ", " ", " ", " ", " ", " "},
    ...
    public CurrentOrders(Object [][] orders){
        numOrders = 3;
        buttonFont = new Font("Impact", Font.PLAIN, 20);
        textFont = new Font("Impact", Font.PLAIN, 20);
        titleFont = new Font("Impact", Font.BOLD, 64);
        table = new JTable(orders, columnNames);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        else if (e.getActionCommand().equals("Get Order Data")){
            Object[][] currentSales = {
                    {"Status", "Order ID", "Name on Order", "Address","Payment Type","Delivery"},
                    { "Ready", "126", "John Doe", "2095 Hwy 54, Moreland","Card","Delivery"},
                    { "In Progress","127", "Drake Swift", "86 Drive Lane Road","Cash","Pick-Up"},
                    { "Ready", "128", "Justin Sheeran", "1215 Jolly Park, Apt 25","Cash","Delivery"},
                    { " ", " ", " ", " ", " ", " "},
                    { " ", " ", " ", " ", " ", " "},
                    { " ", " ", " ", " ", " ", " "},
                    { " ", " ", " ", " ", " ", " "},
